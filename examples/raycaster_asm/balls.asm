...
; global coodinates
MOV intersect_ball - 12, _gx, _flt_size
MOV intersect_ball - 16, _gy, _flt_size
MOV intersect_ball - 20, _gz, _flt_size
; ray coordinates
